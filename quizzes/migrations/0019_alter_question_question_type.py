...
class Migration(migrations.Migration):
    dependencies = [("quizzes", "0018_alter_question_question_type")]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[*[
                    ...
                    ("power_order", "Ordonează puteri"), ("base_values", "Completează scrierea într-o bază"),
                    ("base_match", "Potrivește reprezentări în baze"), ("binary_toggle", "Construiește numărul binar"),
                    ("base_error", "Detectează eroarea de conversie"), ("unit_reduction", "Metoda reducerii la unitate"),
                    ("comparison_method", "Metoda comparației"),
                ]],
                default="multiple_choice", max_length=30,
            ),
        )
    ]
